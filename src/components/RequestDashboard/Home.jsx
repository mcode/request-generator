...
const Home = props => {
    ...
    const renderSectionView = () => {
        ...
        if (section) {
            ...
            return (<div className={classes.mainSectionView}>
                <div
                className={patientRenderClass}>
                    <PatientSection client={props.client} /></div>
                <div 
                className={taskRenderClass}>
                    <TasksSection client={props.client} /></div>
                <div 
                className={settingsRenderClass}>
                    <SettingsSection client = {props.client} /></div>
